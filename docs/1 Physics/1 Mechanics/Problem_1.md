...
- When \( \theta = 0^\circ \) or \( 90^\circ \), the range is zero because:
  ...
  $$ 
  \sin(0^\circ) = 0, \quad \sin(180^\circ) = 0
  $$
...
- The range is reduced (\( R < R_{\text{ideal}} \)).
...
[Link to Colab Example](https://colab.research.google.com/drive/1mG9TDtRfRlfctXJZPtWLedPvlEVRCYe-#scrollTo=ypS30_zpL9aM)
